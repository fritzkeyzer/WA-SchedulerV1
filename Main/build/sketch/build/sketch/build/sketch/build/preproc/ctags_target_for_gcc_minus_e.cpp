# 1 "d:\\_work\\Waterworks Automation\\8 Valve Schedule Controller\\Arduino\\Main\\Main.ino"
# 1 "d:\\_work\\Waterworks Automation\\8 Valve Schedule Controller\\Arduino\\Main\\Main.ino"
/*
...
*/
# 12 "d:\\_work\\Waterworks Automation\\8 Valve Schedule Controller\\Arduino\\Main\\Main.ino"
/*
...
*/
# 20 "d:\\_work\\Waterworks Automation\\8 Valve Schedule Controller\\Arduino\\Main\\Main.ino"
//builtin libraries
# 22 "d:\\_work\\Waterworks Automation\\8 Valve Schedule Controller\\Arduino\\Main\\Main.ino" 2
# 23 "d:\\_work\\Waterworks Automation\\8 Valve Schedule Controller\\Arduino\\Main\\Main.ino" 2
# 24 "d:\\_work\\Waterworks Automation\\8 Valve Schedule Controller\\Arduino\\Main\\Main.ino" 2
# 25 "d:\\_work\\Waterworks Automation\\8 Valve Schedule Controller\\Arduino\\Main\\Main.ino" 2

//custom libraries - also copied to libraries folder
# 28 "d:\\_work\\Waterworks Automation\\8 Valve Schedule Controller\\Arduino\\Main\\Main.ino" 2
# 29 "d:\\_work\\Waterworks Automation\\8 Valve Schedule Controller\\Arduino\\Main\\Main.ino" 2
# 30 "d:\\_work\\Waterworks Automation\\8 Valve Schedule Controller\\Arduino\\Main\\Main.ino" 2
# 31 "d:\\_work\\Waterworks Automation\\8 Valve Schedule Controller\\Arduino\\Main\\Main.ino" 2
# 32 "d:\\_work\\Waterworks Automation\\8 Valve Schedule Controller\\Arduino\\Main\\Main.ino" 2
//#include "FlowSensor.h"
# 34 "d:\\_work\\Waterworks Automation\\8 Valve Schedule Controller\\Arduino\\Main\\Main.ino" 2
...
long sdCheck_good = 30000;
long sdCheck_error = 2000;
...
# 1 "d:\\_work\\Waterworks Automation\\8 Valve Schedule Controller\\Arduino\\Main\\ClockManager.ino"
//settings:
...
void clock_setup()
{
 ...
 if (Clock.lostPower())
 {
  ...
  Clock.adjust(DateTime((reinterpret_cast<const __FlashStringHelper *>(("Nov  7 2019"))), (reinterpret_cast<const __FlashStringHelper *>(("01:37:18")))));
 }
...
# 1 "d:\\_work\\Waterworks Automation\\8 Valve Schedule Controller\\Arduino\\Main\\Control.ino"
...
# 1 "d:\\_work\\Waterworks Automation\\8 Valve Schedule Controller\\Arduino\\Main\\DisplayManager.ino"
//settings:
...
void display_screen_irrigatingVolume()
{
 ...
 lcd.print(arr);
 lcd.setCursor(0, 1);
 sprintf(arr, "%.0f litres", ((state_flowVolume)<(999999)?(state_flowVolume):(999999)));
 lcd.print(arr);
}
...
# 1 "d:\\_work\\Waterworks Automation\\8 Valve Schedule Controller\\Arduino\\Main\\EventManager.ino"
...
void event_update()
{
 ...
 if (state_sequencePos != flag_sequencePos)
 {
  if (flag_sequencePos != -1)
  {
   ...
   char arr[16];
   sprintf(arr, "%.0f", ((volume)<(999999)?(volume):(999999)));
   char arr2[16];
...
# 1 "d:\\_work\\Waterworks Automation\\8 Valve Schedule Controller\\Arduino\\Main\\FlowMeter.ino"
...
void flow_setup(int _interruptPin, float _volumePerTick)
{
 ...
 pinMode(_interruptPin, (0x2));
 attachInterrupt(( _interruptPin ), flow_callback, 2);
 lastTick = millis();
}
...
{
 return ((currentFlowRate)<(flow_calcFlowRate())?(currentFlowRate):(flow_calcFlowRate()));
}
...
# 1 "d:\\_work\\Waterworks Automation\\8 Valve Schedule Controller\\Arduino\\Main\\IOManager.ino"
//mcp object
...
//DotStar LED
Adafruit_DotStar px(1, 41, 40, (1 | (2 << 2) | (0 << 4)) /*|< Transmit as B,R,G*/);
...
{
 //set input pins
 pinMode(pin_moisture, (0x2));
 pinMode(pin_flow, (0x2));
 pinMode(pin_pressure, (0x2));

 mcp.begin(); // use default address 0
 mcp.pinMode(mcpPin_valve0, (0x1));
 mcp.pinMode(mcpPin_valve1, (0x1));
 mcp.pinMode(mcpPin_valve2, (0x1));
 mcp.pinMode(mcpPin_valve3, (0x1));
 mcp.pinMode(mcpPin_valve4, (0x1));
 mcp.pinMode(mcpPin_valve5, (0x1));
 mcp.pinMode(mcpPin_valve6, (0x1));
 mcp.pinMode(mcpPin_valve7, (0x1));
 mcp.pinMode(mcpPin_buttonA, (0x0));
 mcp.pinMode(mcpPin_buttonB, (0x0));
 mcp.pinMode(mcpPin_buttonC, (0x0));
 mcp.pinMode(mcpPin_buttonD, (0x0));
 mcp.pullUp(mcpPin_buttonA, (0x1)); // turn on a 100K pullup internally
 mcp.pullUp(mcpPin_buttonB, (0x1));
 mcp.pullUp(mcpPin_buttonC, (0x1));
 mcp.pullUp(mcpPin_buttonD, (0x1));
...
void io_input_update()
{
 ...
 state_soilMoisture = ((((state_soilMoisture)>(0)?(state_soilMoisture):(0)))<(100)?(((state_soilMoisture)>(0)?(state_soilMoisture):(0))):(100));

 state_pressure = ((input_pressure - input_pressureCalLo)>(0)?(input_pressure - input_pressureCalLo):(0)) * (input_pressureCalHiPressure/(input_pressureCalHi - input_pressureCalLo));
 state_pressure = ((((state_pressure)>(0)?(state_pressure):(0)))<(16)?(((state_pressure)>(0)?(state_pressure):(0))):(16));
...
# 1 "d:\\_work\\Waterworks Automation\\8 Valve Schedule Controller\\Arduino\\Main\\SDCard.ino"
//sd card logging
File file_log;
File file_settings;
...
void sd_setup()
{
 ...
 if (!SD.exists(fileName_log))
 {
  ...
  // Create/Open file
  file_log = SD.open(fileName_log, (O_READ | O_WRITE | O_CREAT));
  if (file_log)
  {
 ...
 /*
	...
	*/
# 63 "d:\\_work\\Waterworks Automation\\8 Valve Schedule Controller\\Arduino\\Main\\SDCard.ino"
}
...
void sd_readSettings()
{
 /*
	...
	*/
# 98 "d:\\_work\\Waterworks Automation\\8 Valve Schedule Controller\\Arduino\\Main\\SDCard.ino"
...
void sd_writeSettings()
{
 ...
 file_settings = SD.open(fileName_settings, (O_READ | O_WRITE | O_CREAT));
 if (file_settings)
 {
 ...
 /*
	...
	*/
# 327 "d:\\_work\\Waterworks Automation\\8 Valve Schedule Controller\\Arduino\\Main\\SDCard.ino"
}
...
# 1 "d:\\_work\\Waterworks Automation\\8 Valve Schedule Controller\\Arduino\\Main\\SettingsEditor.ino"
